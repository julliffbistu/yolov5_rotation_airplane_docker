...
import test_rotation  as test# import test.py to get mAP after each epoch
from models.experimental import attempt_load
from models.yolo_rotation import Model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov5s-air.pt', help='initial weights path')
    ...
    parser.add_argument('--rotation', action='store_true', help='rotation training')
